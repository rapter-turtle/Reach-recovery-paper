...
\begin{figure*}
  ...
  \caption{Representative recovery of the proposed two phase policy in the cradle relative frame. The left panel draws the vessel poses along the path, Phase 1 in blue and Phase 2 in red, with the head point of each pose as a small red circle, together with the mothership side boundary, the dynamic positioning point, the cradle, the reach avoid set at the handoff drawn over the head point, and the handoff instant where control passes to Phase 2. The right panel gives the time histories of the value $V$, the thrust $F$, the rudder $\delta$, and the clearance to the obstacles with the two phase intervals shaded, where the actuators stay within their amplitude limits and the clearance stays above zero throughout.}
