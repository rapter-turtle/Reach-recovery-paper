...
\begin{table}[t]
  \centering
  \caption{Per call computation time over the 100 sea scenarios, compared against the 0.2 s control period. The proposed policy is a single network evaluation.}
  \label{tab_compute}
  \begin{tabular}{lcc}
    \hline
    Controller & Mean [ms] & Max [ms] \\
    \hline
    \textbf{Proposed (two phase)} & \textbf{0.6} & \textbf{1.7} \\
