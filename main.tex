...
Moment arm ($l_r$)       & 3.5 [m]     & $X_u$        & 0.0845  \\
Max thrust ($F_{\max}$)  & 20.5 [N]    & $X_{u|u|}$   & 0.0195  \\
Rudder range             & 57.3 [deg]  & $Y_v$        & 0.0485  \\
$m_{11}, m_{22}, m_{33}$ & 1, 1, 1     & $Y_{v|v|}$   & 0.0988  \\
                         &             & $Y_r$        & 0.151   \\
                         &             & $N_v$        & 0       \\
                         &             & $N_r$        & 0.6939  \\
                         &             & $N_{r|r|}$   & 0       \\
