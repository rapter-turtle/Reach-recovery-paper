...
\begin{figure*}[t]
  ...
  \caption{Head point trajectories over the 100 sea scenarios for the four controllers, in the cradle relative frame. Docks, collisions, and timeouts are drawn in blue, red, and orange, and the cradle pocket and the mothership side boundary are overlaid. The proposed policy docks every scenario, while the barrier baselines collide or time out.}
